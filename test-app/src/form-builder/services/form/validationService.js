...
export const validateFormData = (formData, fields) => {
    ...
    const fieldErrors = validateField(fieldValue, field, formData); // ✅ FIXED: Added formData parameter
 ...
 * @param {Object} formData - Complete form data (for cross-field validation) ✅ FIXED: Added default parameter
 * @returns {Array} - Array of error messages
 */
export const validateField = (value, field, formData = {}) => { // ✅ FIXED: Added default parameter
    const errors = [];
    ...
    switch (type) {
        ...
        if (typeof params.validate === 'function') {
            const isValid = params.validate(value, formData); // ✅ Now formData is properly defined
            if (!isValid) {
